...
- **Indexing**: Vector embeddings with BAAI/bge-base-en-v1.5, automatic chunking, txtai index management (content=False, no internal storage)
...
- **Vector Search**: txtai with BAAI/bge-base-en-v1.5 embeddings
...
- Generates embeddings with bge-base-en-v1.5
